...
detected_faces = set()  # To store detected faces only once
    ...
    if process_this_frame:
        ...
        for face_encoding in face_encodings:
            ...
            if matches[best_match_index]:
                ...
                detected_faces.add(name)  # Add the detected face to set
...
# Save detected faces to CSV
with open(f"Presentees - {today_date}.csv", mode='w', newline='') as presentees_file:
...
# Save absentees to CSV
with open(f"Absentees - {today_date}.csv", mode='w', newline='') as absentees_file:
